...
class RuleError {
     ...
     */
    getErrorMessage(field, alias = "", custom_messages = {}) {
        let error_message = "";
        if (this.rule instanceof rule_1.Rule) {
            ...
            const rule_name = support_1.Str.snake('custom' + this.rule.getName());
     ...
     * @param alias
     */
    replaceAttributePlaceholder(message, field, alias) {
